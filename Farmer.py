...
# Clear the game from recent apps and go back to emulator instance home screen
def close_game():
  global reset_count
  reset_count += 1
...
async def start(ctx):
  # start_game()
  set_preconditions()
  bot.loop.run_in_executor(None, plant_farm_iteration)
